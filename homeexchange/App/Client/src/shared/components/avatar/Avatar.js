...
import "./avatar.scss";
import { selectProfileImg } from './../../redux/imgUploader/selectors';
...
function Avatar({ profileId, alternativeMessage }) {
  ...
  const imgs = useSelector((state) => selectProfileImg(state));
  useEffect(() => {
  ...
  return (
    <div className="avatar">
      <img src={imgSrc} alt={alternativeMessage} className="avatar__img" />
    </div>
  );
}
